...
addEmp({ id: 10, name: "khushi", role: Role.User });
addEmp({ id: "xyz", name: "shiv", role: Role.User });
addEmp({ id: 20, name: "sanju", role: Role.Admin, priviledges: [Priviledge.Read, Priviledge.Write] });
getEmp(0);
getEmp(1);
getEmp(2);
